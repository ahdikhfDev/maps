...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #search-input { width: 100%; padding: 12px 16px 12px 44px; border-radius: 4px; border: 1px solid var(--border-color); font-size: 14px; transition: all 0.2s; background-color: transparent; color: var(--text-bright); }
        #search-input:focus { outline: none; border-color: var(--border-hover); box-shadow: var(--glow-shadow-md); background-color: var(--bg-surface-solid); }
        ...
        .filter-btn { padding: 8px 16px; border: 1px solid var(--border-color); background: transparent; color: var(--text-light); border-radius: 4px; cursor: pointer; font-weight: 600; font-size: 12px; text-transform: uppercase; transition: all 0.2s; }
        .filter-btn:hover { border-color: var(--border-hover); color: var(--primary-color); box-shadow: var(--glow-shadow-sm); }
        .filter-btn.active { background: linear-gradient(90deg, var(--primary-color), var(--secondary-color)); color: var(--bg-dark); border-color: transparent; font-weight: 700; box-shadow: 0 0 15px rgba(255, 0, 193, 0.4); }
        ...
        .location-card { background: transparent; border: 1px solid var(--border-color); border-left: 4px solid var(--border-color); border-radius: 4px; padding: 16px; margin: 0 16px 16px 0; cursor: pointer; transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1); }
        .location-card:hover { transform: translateY(-3px); box-shadow: var(--glow-shadow-md); border-color: var(--border-hover); border-left-color: var(--primary-color); }
        .location-card.active { border-left: 4px solid var(--primary-color); background: rgba(0, 246, 255, 0.05); border-color: var(--border-hover); }
        ...
        .location-category { display: inline-block; padding: 5px 12px; background-color: var(--border-color); color: var(--primary-color); border-radius: 20px; font-size: 11px; font-weight: 700; margin-bottom: 12px; text-transform: uppercase; }
        ...
        .leaflet-top.leaflet-right { top: 15px; right: 15px; } /* Pindah zoom control */
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // GANTI TILE LAYER KE CARTOdb DARK MATTER - TETAP GELAP TAPI DETAIL
